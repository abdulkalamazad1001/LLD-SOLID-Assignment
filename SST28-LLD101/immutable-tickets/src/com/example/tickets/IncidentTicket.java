...
/**
 * A ticket is an immutable record-like object.
 * Created via Builder to ensure atomicity and validation.
 */
public class IncidentTicket {
    ...
    public static Builder from(IncidentTicket other) {
        return new Builder()
                .id(other.id)
                ...
                .tags(other.tags)
                .assigneeEmail(other.assigneeEmail)
                .customerVisible(other.customerVisible)
                .slaMinutes(other.slaMinutes)
                .source(other.source);
    }
